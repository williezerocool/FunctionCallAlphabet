...
public class FunctionCallAlphabet {
    ...
    public static void main( String[] args )
	{
                ...
                e(4);    // pass it the number of letters to display (9)
                f("FAMILY");    // displays the word you pass it beginning with "F"
		...
		n("man");    // displays the word you pass it beginning with "N"
		...
		System.out.println();
		 ...
		 s(4);    // pass it the number of letters to display (6)
		 t("talk");    // displays the word you pass it beginning with "T"
		 ...
		 y();    // displays a word beginning with Y
                 z(false, true);    // returns a different word depending on which two boolean values you pass it
		System.out.println();
	}
